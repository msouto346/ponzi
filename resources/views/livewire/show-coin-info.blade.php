<div>
    <div class="flex shadow">
        <input wire:model.debounce.1000ms="coin" class="w-full rounded p-2" type="search" placeholder="Search by the coin symbol...">
    ...
    @if (strlen($coin) > 2 && is_array($coinResult))
        <div class="text-center pt-10">
            ...
            <p class="font-semibold font-medium">Rank: {{number_format($coinResult['cmc_rank'])}}</p>
            <h4>Price: {{round($coinResult['USD']['price'], 4)}}$ ({{round($coinResult['USD']['percent_change_24h'], 2)}}%)</h4>
        </div>
